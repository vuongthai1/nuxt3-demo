    ...
    <v-dialog v-model="openDialog" width="480" persistent>
        <DialogContentCard @close="onClose()">
            ...
            <template slot="content">
                <p><strong>Are you sure duplicate ?</strong></p>
            </template>
            <template slot="actions">
                <v-btn class="btn btn--ghost btn--gray" @click="onClose()"> Cancel</v-btn>
                <v-btn class="btn btn--primary btn--red" @click="onSubmit()"> Duplicate</v-btn>
            </template>
        </DialogContentCard>
    </v-dialog>
</template>
...
import DialogContentCard from "~/components/elements/Dialog/components/DialogContentCard.vue";
