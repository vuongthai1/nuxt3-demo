    ...
    <v-dialog v-model="openDialog" width="480" persistent>
        <DialogContentCard @close="onClose()">
            ...
            <template slot="actions">
                <v-btn class="btn btn--primary btn--green" @click="onClose()">OK</v-btn>
            </template>
        </DialogContentCard>
    </v-dialog>
</template>
...
export default {
    ...
    props: {
        ...
        message: {
            type: String,
            default: "The information has been updated."
        }
    },
...
.btn--icon-success {
    position: relative;
    top: 0;
    background-color: alpha(var(--color-primary), 0.06) !important;
